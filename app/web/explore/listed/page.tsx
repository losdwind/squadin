            ...
            <TableRow key={squadAugmented.code} className="group text-left">
              ...
              <TableCell className="max-w-xs">
                <div className="flex flex-col">
                  <div className="text-md py-1 font-medium">
                    {squadAugmented.name}
                  </div>
              ...
              <TableCell
                className={
                  squadAugmented.change < 0 ? "text-red-500" : "text-green-500"
                }
              >
                {(squadAugmented.change * 100).toFixed(2)}%
              </TableCell>
              <TableCell>
                {formatMarketCap({ value: squadAugmented.market_cap })}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
